...
public class RPSLSpock {
    ...
    /**
     *
     * @param pick what the user has typed/entered
     * @return true if pick is ROCK, PAPER, SCISSORS, LIZARD, or SPOCK
     */
    ...
    /**
     *
     * @return choses a random pick from the list of ROCK, PAPER, SCISSORS, LIZARD, SPOCK
     */
     ...
     * @return true if computer wins, false if human wins
     */
